...
export default function Rqst() {
  ...
  return (
    <div>
        <Header/>
        <div className='bg-black w-screen h-screen text-white p-32 flex flex-col justify-center items-center'>
            ...
            <button style={{marginTop:"10px"}}className='btn'>Submit</button>
            </div>          
        </div>
    </div>
  )
